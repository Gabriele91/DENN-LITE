...
namespace Denn
{
	...
	///////////////////////////////////////////////////////////////////////////
	const std::vector< std::string > Layer::activations_names() const
	{
		std::vector< std::string > out;
		for (auto activation : activations())
		{
			out.push_back(ActivationFunctionFactory::name_of(activation));
		}
		return out;
	}
	///////////////////////////////////////////////////////////////////////////
	...
	)
	{
		...
		//return
		return it == lr_map().end() ? nullptr : it->second.m_create(active_functions, shape, inputs);
	}
