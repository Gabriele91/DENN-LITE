...
namespace Denn
{
	class DefaultInstance2 : public Instance
	{
	public:
		//local info
		...
		//init
		DefaultInstance2(const Denn::Parameters& parameters) : m_parameters(parameters)
		{
			////////////////////////////////////////////////////////////////////////////////////////////////
			//init
	...
	REGISTERED_INSTANCE(DefaultInstance2, "default2")
}
