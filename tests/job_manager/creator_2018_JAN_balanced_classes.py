...
def main():
    ...
    DATASETS = [
        (2000, 10, 20, 123, (-150, 150), "QSAR", "../../DENN-dataset-samples/DATASETS/d_06_01_2018/qsar_balanced_classes.gz"),
        (2000, 10, 20, 123, (-1, 1), "QSAR_norm", "../../DENN-dataset-samples/DATASETS/d_06_01_2018/qsar_balanced_classes_normalized.gz"),
        (2000, 20, 40, 33, (-600, 600), "MAGIC", "../../DENN-dataset-samples/DATASETS/d_06_01_2018/magic_balanced_classes.gz"),
        (2000, 20, 40, 33, (-1, 1), "MAGIC_norm", "../../DENN-dataset-samples/DATASETS/d_06_01_2018/magic_balanced_classes_normalized.gz"),
        (2000, 20, 40, 384, (-70000, 70000), "GASS", "../../DENN-dataset-samples/DATASETS/d_06_01_2018/gass_balanced_classes.gz"),
        (2000, 20, 40, 384, (-1, 1), "GASS_norm", "../../DENN-dataset-samples/DATASETS/d_06_01_2018/gass_balanced_classes_normalized.gz"),
        (4000, 100, 100, 400, (-255, 255), "MNIST", "../../DENN-dataset-samples/DATASETS/d_06_01_2018/mnist_balanced_classes.gz"),
        (4000, 100, 100, 400, (-1, 1), "MNIST_norm", "../../DENN-dataset-samples/DATASETS/d_06_01_2018/mnist_balanced_classes_normalized.gz"),
        (4000, 100, 100, 400, (-255, 255), "FASHION_MNIST", "../../DENN-dataset-samples/DATASETS/d_06_01_2018/fashion-mnist_balanced_classes.gz"),
        (4000, 100, 100, 400, (-1, 1), "FASHION_MNIST_norm", "../../DENN-dataset-samples/DATASETS/d_06_01_2018/fashion-mnist_balanced_classes_normalized.gz"),
    ]
    ...
    with open("jobs/job_2018_JAN_balanced_classes.csv", "w") as out_file:
        ##### -> datasets
